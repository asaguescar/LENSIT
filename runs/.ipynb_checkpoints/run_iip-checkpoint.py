...
class glSNIIP(skysurvey.target.core.Transient):
    _KIND = "GLSNIIP"
...
while ndet_total < 100000:
    ...
    glsniip = glSNIIP.from_data(data)

    dset = DataSet.from_targets_and_survey(glsniip, ztf_survey)
    ...
    outputfilename = lensfile[:-4] + '_dset_iip_s11-2005lc.pkl'
