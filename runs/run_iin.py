...
class glSNIIn(skysurvey.target.core.Transient):
    _KIND = "GLSNIIn"
...
while ndet_total < 100000:
    ...
    glsniin = glSNIIn.from_data(data)

    dset = DataSet.from_targets_and_survey(glsniin, ztf_survey)
    ...
    outputfilename = lensfile[:-4] + '_dset_iin_nugent-sn2n.pkl'
