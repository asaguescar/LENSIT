...
alpha= 1.5
df['weight'] = add_weight_fromuniformz(df.z, zmax=zmax, Rloc = Rloc, alpha= alpha, fraction_sky=fraction_sky)
df.to_pickle('../sim_output/dset_ia_salt2.pkl')
...
alpha= 1.5
df['weight'] = add_weight_fromuniformz(df.z, zmax=zmax, Rloc = Rloc, alpha= alpha, fraction_sky=fraction_sky)
df.to_pickle('../sim_output/dset_ia_hsiao.pkl')
...
alpha= 2.
df['weight'] = add_weight_fromuniformz(df.z, zmax=zmax, Rloc = Rloc, alpha= alpha, fraction_sky=fraction_sky)
df.to_pickle('../sim_output/dset_iip.pkl')
...
alpha= 2.
df['weight'] = add_weight_fromuniformz(df.z, zmax=zmax, Rloc = Rloc, alpha= alpha, fraction_sky=fraction_sky)
df.to_pickle('../sim_output/dset_iin.pkl')
...
alpha= 2.
df['weight'] = add_weight_fromuniformz(df.z, zmax=zmax, Rloc = Rloc, alpha= alpha, fraction_sky=fraction_sky)
df.to_pickle('../sim_output/dset_ibc.pkl')
