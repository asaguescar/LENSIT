...
out_ia_salt2 = glsneibc_sample(outlensed.to_dict('list'), cosmo)
del outlensed
...
del out_ia_salt2
sample = GLSNe_sn1bc.from_data(ia_salt2[ia_salt2.Lensed==1])
del ia_salt2
...
outputfilename = lensfile[:-4]+'_dset_ibc.pkl'
